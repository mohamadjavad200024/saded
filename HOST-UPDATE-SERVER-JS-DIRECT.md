# آپدیت مستقیم server.js

## مشکل:
- server.js آپدیت نمی‌شود
...
# 1. بررسی محتوای فعلی server.js
echo "=== Current server.js (first 30 lines) ==="
head -30 server.js

# 2. بررسی اینکه آیا فایل قابل نوشتن است
ls -la server.js

# 3. آپدیت مستقیم server.js با vi یا nano
# یا استفاده از دستور زیر:
cat > /tmp/server.js.new << 'EOFMARKER'
...
# 4. کپی فایل جدید به server.js
cp /tmp/server.js.new server.js

# 5. بررسی اینکه فایل آپدیت شده
...
## یا استفاده از git pull:

```bash
# اگر server.js در git است:
