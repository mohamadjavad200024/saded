        ...
        "useChatUtils.useCallback[saveRecording]": async ()=>{
            if (audioBlob && audioUrl) {
                try {
                    ...
                    setAttachments({
                        "useChatUtils.useCallback[saveRecording]": (prev)=>[
                                ...prev,
                                attachment
                            ]
...
_s(useChatUtils, "KEH38FRcaZ90V769Ss1PTGnyr2g=", false, function() {
    return [
...
function AdminChat({ isOpen, onOpenChange }) {
    ...
    // Silent refresh
    const silentRefreshChats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminChat.useCallback[silentRefreshChats]": async ()=>{
            try {
                const response = await fetch("/api/chat");
                if (!response.ok) return;
                const data = await response.json();
                if (data.success && data.data.chats) {
                    const chatPromises = data.data.chats.map({
                        "AdminChat.useCallback[silentRefreshChats].chatPromises": async (chat)=>{
                            try {
                                const msgResponse = await fetch(`/api/chat?chatId=${chat.id}`);
                                if (msgResponse.ok) {
                                    const msgData = await msgResponse.json();
                    ...
                    }["AdminChat.useCallback[silentRefreshChats].chatPromises"]);
                    const results = await Promise.allSettled(chatPromises);
                    const updatedChats = results.filter({
                        "AdminChat.useCallback[silentRefreshChats].updatedChats": (r)=>r.status === "fulfilled"
                    }["AdminChat.useCallback[silentRefreshChats].updatedChats"]).map({
                        "AdminChat.useCallback[silentRefreshChats].updatedChats": (r)=>r.value
                    }["AdminChat.useCallback[silentRefreshChats].updatedChats"]);
                    setChats({
                        "AdminChat.useCallback[silentRefreshChats]": (prevChats)=>{
                            const chatMap = new Map(updatedChats.map({
                                "AdminChat.useCallback[silentRefreshChats]": (c)=>[
                                        c.id,
                                        c
                                    ]
                            }["AdminChat.useCallback[silentRefreshChats]"]));
                            const existingIds = new Set(prevChats.map({
                                "AdminChat.useCallback[silentRefreshChats]": (c)=>c.id
                            }["AdminChat.useCallback[silentRefreshChats]"]));
                            const mergedChats = prevChats.map({
                                "AdminChat.useCallback[silentRefreshChats].mergedChats": (c)=>{
                            ...
                            }["AdminChat.useCallback[silentRefreshChats].mergedChats"]);
    ...
    const handleSend = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminChat.useCallback[handleSend]": async ()=>{
            ...
            if (sentMessage) {
                ...
                }["AdminChat.useCallback[handleSend]"], 150);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminChat.useEffect": ()=>{
            ...
            const checkOnMessagesChange = {
                "AdminChat.useEffect.checkOnMessagesChange": ()=>{
                    setTimeout({
                        "AdminChat.useEffect.checkOnMessagesChange": ()=>{
                            checkScrollPosition();
                        }
                    }["AdminChat.useEffect.checkOnMessagesChange"], 100);
                }
            }["AdminChat.useEffect.checkOnMessagesChange"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminChat.useEffect": ()=>{
            const handleOpenChat = {
                "AdminChat.useEffect.handleOpenChat": async (event)=>{
                    ...
                    setTimeout({
                        "AdminChat.useEffect.handleOpenChat": async ()=>{
                            if (chats.length === 0) {
                                await loadChats();
                            }
                            const chat = chats.find({
                                "AdminChat.useEffect.handleOpenChat.chat": (c)=>c.id === chatId
                            }["AdminChat.useEffect.handleOpenChat.chat"]);
                            if (chat) {
                                ...
                                try {
                                    ...
                                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error("Error loading chat:", error);
                                }
                            }
                        }
                    }["AdminChat.useEffect.handleOpenChat"], 300);
                }
            }["AdminChat.useEffect.handleOpenChat"];
...
_s(AdminChat, "LvLFcCyeFAkc8/3bxy3pvnetJ+8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
...
_s(AdminHeader, "WSqzNIFTzh7pDPTqCp95o3ftuEo=");
_c = AdminHeader;
var _c;
        ...
        loadOrdersFromDB: async ()=>{
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error("Failed to load orders:", response.status);
...
//# sourceMappingURL=_9666b4e3._.js.map