...
function SafeImage({ src, alt, fill = false, width, height, className = "", priority = false, loading = "eager", sizes, onError, placeholder = "empty", blurDataURL, productId }) {
    _s();
    const getProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$product$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductStore"])({
        "SafeImage.useProductStore[getProduct]": (state)=>state.getProduct
    }["SafeImage.useProductStore[getProduct]"]);
    const placeholderUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPlaceholderImage"])(width || 600, height || 600);
    // دریافت URL تصویر
    const getImageUrl = ()=>{
        // 1. از src prop
    ...
    const [imageSrc, setImageSrc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "SafeImage.useState": ()=>getImageUrl()
    }["SafeImage.useState"]);
...
_s(SafeImage, "ExAXx9KXefu3aYgM9OWDusRV4Ow=", false, function() {
    return [
...
//# sourceMappingURL=_e42b3575._.js.map