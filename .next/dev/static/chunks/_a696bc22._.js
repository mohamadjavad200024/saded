...
function ChatPage() {
    ...
    const loadCustomerInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[loadCustomerInfo]": ()=>{
            ...
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error("Error loading customer info:", error);
            }
            return {
                name: "",
                phone: "",
    ...
    const handleSubmitInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleSubmitInfo]": async ()=>{
            if (!customerInfo.name || !customerInfo.phone) {
                toast({
                    title: "خطا",
    ...
    }["ChatPage.useCallback[handleSubmitInfo]"], [
        customerInfo,
        toast
    ]);
    // Format time
    const formatTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[formatTime]": (seconds)=>{
            const mins = Math.floor(seconds / 60);
            const secs = seconds % 60;
            return `${mins.toString().padStart(2, "0")}:${secs.toString().padStart(2, "0")}`;
        }
    }["ChatPage.useCallback[formatTime]"], []);
    ...
    const checkMicrophonePermission = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[checkMicrophonePermission]": async ()=>{
            try {
                const stream = await navigator.mediaDevices.getUserMedia({
                    audio: true
                });
                stream.getTracks().forEach({
                    "ChatPage.useCallback[checkMicrophonePermission]": (track)=>track.stop()
                }["ChatPage.useCallback[checkMicrophonePermission]"]);
                return true;
            } catch (error) {
    ...
    const startRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[startRecording]": async ()=>{
            try {
                ...
                mediaRecorder.ondataavailable = ({
                    "ChatPage.useCallback[startRecording]": (e)=>{
                        if (e.data.size > 0) chunks.push(e.data);
                    }
                })["ChatPage.useCallback[startRecording]"];
                mediaRecorder.onstop = ({
                    "ChatPage.useCallback[startRecording]": ()=>{
                        ...
                        setAudioUrl(url);
                        stream.getTracks().forEach({
                            "ChatPage.useCallback[startRecording]": (track)=>track.stop()
                        }["ChatPage.useCallback[startRecording]"]);
                    }
                })["ChatPage.useCallback[startRecording]"];
                mediaRecorder.start();
                ...
                const interval = setInterval({
                    "ChatPage.useCallback[startRecording].interval": ()=>{
                        setRecordingTime({
                            "ChatPage.useCallback[startRecording].interval": (prev)=>prev + 1
                        }["ChatPage.useCallback[startRecording].interval"]);
                    }
                }["ChatPage.useCallback[startRecording].interval"], 1000);
    ...
    const stopRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[stopRecording]": ()=>{
    ...
    const cancelRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[cancelRecording]": ()=>{
            stopRecording();
            setAudioUrl(null);
            setAudioBlob(null);
            setRecordingTime(0);
    ...
    const saveRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[saveRecording]": async ()=>{
            ...
            try {
                ...
                if (data.success && data.data?.url) {
                    ...
                    setAttachments({
                        "ChatPage.useCallback[saveRecording]": (prev)=>[
                                ...prev,
                                attachment
                            ]
                    }["ChatPage.useCallback[saveRecording]"]);
                    setAudioUrl(null);
                    setAudioBlob(null);
                    setRecordingTime(0);
                }
    ...
    const handleFileSelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleFileSelect]": async (e, type)=>{
            ...
            try {
                for(let i = 0; i < files.length; i++){
                    ...
                    if (data.success && data.data?.url) {
                        ...
                        setAttachments({
                            "ChatPage.useCallback[handleFileSelect]": (prev)=>[
                                    ...prev,
                                    attachment
                                ]
                        }["ChatPage.useCallback[handleFileSelect]"]);
                    }
                }
            } catch (error) {
    ...
    const handleLocationShare = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleLocationShare]": ()=>{
            ...
            navigator.geolocation.getCurrentPosition({
                "ChatPage.useCallback[handleLocationShare]": (position)=>{
                    ...
                    setAttachments({
                        "ChatPage.useCallback[handleLocationShare]": (prev)=>[
                                ...prev,
                                attachment
                            ]
                    }["ChatPage.useCallback[handleLocationShare]"]);
                ...
                "ChatPage.useCallback[handleLocationShare]": (error)=>{
    ...
    const handleRemoveAttachment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleRemoveAttachment]": (id)=>{
            setAttachments({
                "ChatPage.useCallback[handleRemoveAttachment]": (prev)=>prev.filter({
                        "ChatPage.useCallback[handleRemoveAttachment]": (att)=>att.id !== id
                    }["ChatPage.useCallback[handleRemoveAttachment]"])
            }["ChatPage.useCallback[handleRemoveAttachment]"]);
        }
    }["ChatPage.useCallback[handleRemoveAttachment]"], []);
    // Send typing status
    const sendTypingStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[sendTypingStatus]": async (isTyping)=>{
            if (!chatId) return;
            try {
    ...
    }["ChatPage.useCallback[sendTypingStatus]"], [
        chatId
    ]);
    ...
    const pollForNewMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[pollForNewMessages]": async ()=>{
            if (!chatId) return;
            try {
                ...
                if (data.success && data.data?.messages) {
                    const formattedMessages = data.data.messages.map({
                        "ChatPage.useCallback[pollForNewMessages].formattedMessages": (msg)=>({
                                id: msg.id,
                                text: msg.text || "",
                                sender: msg.sender,
                    ...
                    }["ChatPage.useCallback[pollForNewMessages].formattedMessages"]);
    ...
    }["ChatPage.useCallback[pollForNewMessages]"], [
        chatId
    ]);
    ...
    const checkSupportTyping = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[checkSupportTyping]": async ()=>{
            if (!chatId) return;
            try {
    ...
    }["ChatPage.useCallback[checkSupportTyping]"], [
        chatId
    ]);
    // Handle send message
        ...
        "ChatPage.useCallback[handleSendMessage]": async ()=>{
            ...
            if (editingMessage) {
                try {
                    ...
                    if (response.ok) {
                        setMessages({
                            "ChatPage.useCallback[handleSendMessage]": (prev)=>prev.map({
                                    "ChatPage.useCallback[handleSendMessage]": (msg)=>msg.id === editingMessage.id ? {
                                            ...msg,
                                            text: message,
                                            attachments: attachments
                                        } : msg
            ...
            setMessages({
                "ChatPage.useCallback[handleSendMessage]": (prev)=>[
                        ...prev,
                        newMessage
                    ]
            }["ChatPage.useCallback[handleSendMessage]"]);
            ...
            try {
                ...
                if (data.success && data.data) {
                    setMessages({
                        "ChatPage.useCallback[handleSendMessage]": (prev)=>prev.map({
                                "ChatPage.useCallback[handleSendMessage]": (msg)=>msg.id === tempId ? {
                                        ...msg,
                                        id: data.data.id,
                                        status: "sent"
                                    } : msg
                ...
                setMessages({
                    "ChatPage.useCallback[handleSendMessage]": (prev)=>prev.filter({
                            "ChatPage.useCallback[handleSendMessage]": (msg)=>msg.id !== tempId
                        }["ChatPage.useCallback[handleSendMessage]"])
                }["ChatPage.useCallback[handleSendMessage]"]);
                toast({
            ...
            }["ChatPage.useCallback[handleSendMessage]"], 100);
        }
    }["ChatPage.useCallback[handleSendMessage]"], [
        chatId,
        message,
    ...
    const handleReply = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleReply]": (msg)=>{
            setReplyingTo(msg);
            setEditingMessage(null);
        }
    ...
    const handleEdit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleEdit]": (msg)=>{
    ...
    const handleDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[handleDelete]": async (messageId)=>{
            try {
                ...
                if (response.ok) {
                    setMessages({
                        "ChatPage.useCallback[handleDelete]": (prev)=>prev.filter({
                                "ChatPage.useCallback[handleDelete]": (msg)=>msg.id !== messageId
    ...
    const scrollToBottom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[scrollToBottom]": (instant = false)=>{
    ...
    const checkScrollPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPage.useCallback[checkScrollPosition]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            ...
            }["ChatPage.useEffect.interval"], 3000);
            return ({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            ...
            if (!container) return;
            const handleScroll = {
                "ChatPage.useEffect.handleScroll": ()=>{
                    checkScrollPosition();
                }
            }["ChatPage.useEffect.handleScroll"];
            ...
            return ({
                "ChatPage.useEffect": ()=>container.removeEventListener("scroll", handleScroll)
            })["ChatPage.useEffect"];
        }
    }["ChatPage.useEffect"], [
        checkScrollPosition
...
_s(ChatPage, "skfPETjqipeVIBM9fzdAheItJqM=", false, function() {
    return [
...
//# sourceMappingURL=_a696bc22._.js.map