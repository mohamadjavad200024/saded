...
"[project]/components/admin/product-table.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProductTable({ products, onRefresh }) {
    ...
    const { deleteProduct, toggleProduct, deleteProducts, toggleProducts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$product$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductStore"])();
...
_s(ProductTable, "Z7bhZgnJF+A//EVr4bqnxvLB59k=", false, function() {
    return [
        ...
        refreshStats: async ()=>{
            ...
            try {
                ...
                try {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].warn("Could not fetch order stats:", error);
                }
                set({
                    stats,
                    isLoading: false
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$admin$2f$product$2d$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/admin/product-table.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/button.tsx [app-client] (ecmascript)");
...
function ProductsPage() {
    _s();
    const { products, setFilters, clearFilters, filters, loadProductsFromDB } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$product$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductStore"])();
    const { refreshStats } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$admin$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminStore"])();
    ...
    const [categoryFilter, setCategoryFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(filters.categories?.[0] || "all");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductsPage.useEffect": ()=>{
            const loadProducts = {
                "ProductsPage.useEffect.loadProducts": async ()=>{
                    setIsLoading(true);
                    try {
            ...
            }["ProductsPage.useEffect.loadProducts"];
            loadProducts();
        }
    }["ProductsPage.useEffect"], [
        loadProductsFromDB,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductsPage.useEffect": ()=>{
            const handleProductCreated = {
                "ProductsPage.useEffect.handleProductCreated": ()=>{
                    loadProductsFromDB(true);
                }
            }["ProductsPage.useEffect.handleProductCreated"];
            const handleProductUpdated = {
                "ProductsPage.useEffect.handleProductUpdated": ()=>{
                    loadProductsFromDB(true);
                }
            }["ProductsPage.useEffect.handleProductUpdated"];
            const handleStorageChange = {
                "ProductsPage.useEffect.handleStorageChange": (e)=>{
                    if (e.key === 'product-created' || e.key === 'product-updated') {
                        loadProductsFromDB(true);
                    }
                }
            }["ProductsPage.useEffect.handleStorageChange"];
    ...
    const filteredProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductsPage.useMemo[filteredProducts]": ()=>{
            ...
            if (searchQuery) {
                ...
                filtered = filtered.filter({
                    "ProductsPage.useMemo[filteredProducts]": (p)=>p.name.toLowerCase().includes(query) || p.brand?.toLowerCase().includes(query) || p.description?.toLowerCase().includes(query)
                }["ProductsPage.useMemo[filteredProducts]"]);
            }
            ...
            if (statusFilter === "active") {
                filtered = filtered.filter({
                    "ProductsPage.useMemo[filteredProducts]": (p)=>p.enabled
                }["ProductsPage.useMemo[filteredProducts]"]);
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: [
                            ...
                            (searchQuery || categoryFilter !== "all" || statusFilter !== "all") && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-4",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    variant: "ghost",
                                    size: "sm",
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 259,
                            columnNumber: 13
                        }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$admin$2f$product$2d$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductTable"], {
...
_s(ProductsPage, "Div/AxcG2oikeukAXn/Xr/S/Zo4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$product$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductStore"],
...
//# sourceMappingURL=_99f614c0._.js.map