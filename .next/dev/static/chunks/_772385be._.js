...
function ProtectedRoute({ children, requireAuth = true, requireAdmin = false }) {
    ...
    const { user, isAuthenticated, hasCheckedAuth, isCheckingAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    const hasRedirectedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
...
_s(ProtectedRoute, "1/iclOiy/LZ8eRkHkDEyMiFdHDw=", false, function() {
    return [
...
function ChatPageContent() {
    ...
    const loadCustomerInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[loadCustomerInfo]": ()=>{
    ...
    const shouldAutoSendRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    // Initialize user's chat (server-side, session-based)
    const initMyChat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[initMyChat]": async (opts)=>{
            // Authentication removed - chat is now open to everyone
            try {
                // Wait a bit to ensure cookie is available (especially after login)
                await new Promise({
                    "ChatPageContent.useCallback[initMyChat]": (resolve)=>setTimeout(resolve, 200)
                }["ChatPageContent.useCallback[initMyChat]"]);
                ...
                for(let attempt = 0; attempt < 3; attempt++){
                    try {
                        ...
                        const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"].getState().user;
                        const headers = {
                        ...
                        if (res.status === 401) {
                            ...
                            const recheckData = await recheck.json().catch({
                                "ChatPageContent.useCallback[initMyChat]": ()=>null
                            }["ChatPageContent.useCallback[initMyChat]"]);
                            ...
                            if (attempt < 2) {
                                await new Promise({
                                    "ChatPageContent.useCallback[initMyChat]": (resolve)=>setTimeout(resolve, 500)
                                }["ChatPageContent.useCallback[initMyChat]"]);
                                continue;
                            }
                        }
    ...
    const pollForNewMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[pollForNewMessages]": async (chatIdOverride)=>{
            ...
            try {
                ...
                if (data.success && data.data?.messages) {
                    const formattedMessages = data.data.messages.map({
                        "ChatPageContent.useCallback[pollForNewMessages].formattedMessages": (msg)=>({
                                id: msg.id,
                                text: msg.text || "",
                                sender: msg.sender,
                    ...
                    }["ChatPageContent.useCallback[pollForNewMessages].formattedMessages"]);
                    // Merge with existing messages and remove deleted ones
                    setMessages({
                        "ChatPageContent.useCallback[pollForNewMessages]": (prev)=>{
                            const dbMessageIds = new Set(formattedMessages.map({
                                "ChatPageContent.useCallback[pollForNewMessages]": (m)=>m.id
                            }["ChatPageContent.useCallback[pollForNewMessages]"]));
                            const existingIds = new Set(prev.map({
                                "ChatPageContent.useCallback[pollForNewMessages]": (m)=>m.id
                            }["ChatPageContent.useCallback[pollForNewMessages]"]));
                            const uniqueNewMessages = formattedMessages.filter({
                                "ChatPageContent.useCallback[pollForNewMessages].uniqueNewMessages": (msg)=>!existingIds.has(msg.id)
                            }["ChatPageContent.useCallback[pollForNewMessages].uniqueNewMessages"]);
                            // Update status of existing messages from database
                            const updatedPrev = prev.filter({
                                "ChatPageContent.useCallback[pollForNewMessages].updatedPrev": (existingMsg)=>{
                            ...
                            }["ChatPageContent.useCallback[pollForNewMessages].updatedPrev"]).map({
                                "ChatPageContent.useCallback[pollForNewMessages].updatedPrev": (existingMsg)=>{
                                    const dbMsg = formattedMessages.find({
                                        "ChatPageContent.useCallback[pollForNewMessages].updatedPrev.dbMsg": (m)=>m.id === existingMsg.id
                                    }["ChatPageContent.useCallback[pollForNewMessages].updatedPrev.dbMsg"]);
                            ...
                            }["ChatPageContent.useCallback[pollForNewMessages].updatedPrev"]);
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error("Error polling messages:", error);
            }
        }
    }["ChatPageContent.useCallback[pollForNewMessages]"], [
        chatId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPageContent.useEffect": ()=>{
            ...
            const timeoutId = setTimeout({
                "ChatPageContent.useEffect.timeoutId": ()=>{
                    initMyChat({
                        silent: true
                    }).catch({
                        "ChatPageContent.useEffect.timeoutId": ()=>null
                    }["ChatPageContent.useEffect.timeoutId"]);
                }
            }["ChatPageContent.useEffect.timeoutId"], 500);
            return ({
                "ChatPageContent.useEffect": ()=>clearTimeout(timeoutId)
            })["ChatPageContent.useEffect"];
        }
    }["ChatPageContent.useEffect"], [
        user,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPageContent.useEffect": ()=>{
            ...
            const t = setInterval({
                "ChatPageContent.useEffect.t": ()=>pollForNewMessages(chatId)
            }["ChatPageContent.useEffect.t"], 3000);
            return ({
                "ChatPageContent.useEffect": ()=>clearInterval(t)
            })["ChatPageContent.useEffect"];
        }
    }["ChatPageContent.useEffect"], [
        chatId,
    ...
    const createChat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[createChat]": async (info, opts)=>{
            ...
            try {
                ...
                const data = await response.json().catch({
                    "ChatPageContent.useCallback[createChat]": ()=>null
                }["ChatPageContent.useCallback[createChat]"]);
    ...
    const handleSubmitInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[handleSubmitInfo]": async ()=>{
            // Chat is session-based; just ensure we have a chatId for the current user
            await initMyChat({
                silent: false
            });
        }
    }["ChatPageContent.useCallback[handleSubmitInfo]"], [
        initMyChat
    ]);
    // Format time
    const formatTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[formatTime]": (seconds)=>{
            const mins = Math.floor(seconds / 60);
            const secs = seconds % 60;
            return `${mins.toString().padStart(2, "0")}:${secs.toString().padStart(2, "0")}`;
        }
    }["ChatPageContent.useCallback[formatTime]"], []);
    ...
    const checkMicrophonePermission = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[checkMicrophonePermission]": async ()=>{
            try {
                const stream = await navigator.mediaDevices.getUserMedia({
                    audio: true
                });
                stream.getTracks().forEach({
                    "ChatPageContent.useCallback[checkMicrophonePermission]": (track)=>track.stop()
                }["ChatPageContent.useCallback[checkMicrophonePermission]"]);
                return true;
            } catch (error) {
    ...
    const startRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[startRecording]": async ()=>{
            try {
                ...
                mediaRecorder.ondataavailable = ({
                    "ChatPageContent.useCallback[startRecording]": (e)=>{
                        if (e.data.size > 0) chunks.push(e.data);
                    }
                })["ChatPageContent.useCallback[startRecording]"];
                mediaRecorder.onstop = ({
                    "ChatPageContent.useCallback[startRecording]": ()=>{
                        ...
                        setAudioUrl(url);
                        stream.getTracks().forEach({
                            "ChatPageContent.useCallback[startRecording]": (track)=>track.stop()
                        }["ChatPageContent.useCallback[startRecording]"]);
                    }
                })["ChatPageContent.useCallback[startRecording]"];
                mediaRecorder.start();
                ...
                const interval = setInterval({
                    "ChatPageContent.useCallback[startRecording].interval": ()=>{
                        setRecordingTime({
                            "ChatPageContent.useCallback[startRecording].interval": (prev)=>prev + 1
                        }["ChatPageContent.useCallback[startRecording].interval"]);
                    }
                }["ChatPageContent.useCallback[startRecording].interval"], 1000);
    ...
    const stopRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[stopRecording]": ()=>{
    ...
    const cancelRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[cancelRecording]": ()=>{
            stopRecording();
            setAudioUrl(null);
            setAudioBlob(null);
            setRecordingTime(0);
    ...
    const saveRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[saveRecording]": async ()=>{
            ...
            try {
                ...
                if (data.success && data.data?.url) {
                    ...
                    setAttachments({
                        "ChatPageContent.useCallback[saveRecording]": (prev)=>{
                            // Check if attachment already exists to avoid duplicates
                            const exists = prev.some({
                                "ChatPageContent.useCallback[saveRecording].exists": (att)=>att.id === attachment.id
                            }["ChatPageContent.useCallback[saveRecording].exists"]);
                            if (exists) {
                    ...
                    }["ChatPageContent.useCallback[saveRecording]"]);
                    setAudioUrl(null);
                    setAudioBlob(null);
                    setRecordingTime(0);
    ...
    const handleFileSelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[handleFileSelect]": async (e, type)=>{
                ...
                for(let i = 0; i < files.length; i++){
                    ...
                    if (!response.ok) {
                        const errorData = await response.json().catch({
                            "ChatPageContent.useCallback[handleFileSelect]": ()=>null
                        }["ChatPageContent.useCallback[handleFileSelect]"]);
                    ...
                    if (data.success && data.data?.url) {
                        ...
                        setAttachments({
                            "ChatPageContent.useCallback[handleFileSelect]": (prev)=>[
                                    ...prev,
                                    attachment
                                ]
                        }["ChatPageContent.useCallback[handleFileSelect]"]);
    ...
    const handleLocationShare = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[handleLocationShare]": ()=>{
            ...
            navigator.geolocation.getCurrentPosition({
                "ChatPageContent.useCallback[handleLocationShare]": (position)=>{
                    ...
                    setAttachments({
                        "ChatPageContent.useCallback[handleLocationShare]": (prev)=>{
                            const newAttachments = [
                                ...prev,
                                attachment
                            ];
                ...
                "ChatPageContent.useCallback[handleLocationShare]": (error)=>{
    ...
    const handleRemoveAttachment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[handleRemoveAttachment]": (id)=>{
            setAttachments({
                "ChatPageContent.useCallback[handleRemoveAttachment]": (prev)=>prev.filter({
                        "ChatPageContent.useCallback[handleRemoveAttachment]": (att)=>att.id !== id
                    }["ChatPageContent.useCallback[handleRemoveAttachment]"])
            }["ChatPageContent.useCallback[handleRemoveAttachment]"]);
        }
    }["ChatPageContent.useCallback[handleRemoveAttachment]"], []);
    // Send typing status
    const sendTypingStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[sendTypingStatus]": async (isTyping)=>{
            if (!chatId) return;
            try {
    ...
    }["ChatPageContent.useCallback[sendTypingStatus]"], [
        chatId
    ]);
    // Update customer info when auth state changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const checkSupportTyping = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[checkSupportTyping]": async ()=>{
            if (!chatId) return;
            try {
    ...
    }["ChatPageContent.useCallback[checkSupportTyping]"], [
        chatId
    ]);
    // Handle send message
    const handleSendMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[handleSendMessage]": async ()=>{
            // ProtectedRoute ensures user exists, so we can safely use it
            ...
            if (editingMessage) {
                try {
                    ...
                    if (response.ok) {
                        setMessages({
                            "ChatPageContent.useCallback[handleSendMessage]": (prev)=>prev.map({
                                    "ChatPageContent.useCallback[handleSendMessage]": (msg)=>msg.id === editingMessage.id ? {
                                            ...msg,
                                            text: currentText,
                                            attachments: attachments
                                        } : msg
                                }["ChatPageContent.useCallback[handleSendMessage]"])
                        }["ChatPageContent.useCallback[handleSendMessage]"]);
            ...
            setMessages({
                "ChatPageContent.useCallback[handleSendMessage]": (prev)=>[
                        ...prev,
                        newMessage
                    ]
            }["ChatPageContent.useCallback[handleSendMessage]"]);
            ...
            try {
                ...
                const messageToSave = {
                    ...
                    attachments: attachments.filter({
                        "ChatPageContent.useCallback[handleSendMessage]": (att)=>{
                            const url = att.url;
                ...
                if (data.success && data.data?.messages && data.data.messages.length > 0) {
                    ...
                    requestAnimationFrame({
                        "ChatPageContent.useCallback[handleSendMessage]": ()=>{
                            setMessages({
                                "ChatPageContent.useCallback[handleSendMessage]": (prev)=>prev.map({
                                        "ChatPageContent.useCallback[handleSendMessage]": (msg)=>msg.id === tempId ? {
                                                ...msg,
                                                id: savedMessage.id,
                ...
                }["ChatPageContent.useCallback[handleSendMessage]"], 1000);
            } catch (error) {
                ...
                setMessages({
                    "ChatPageContent.useCallback[handleSendMessage]": (prev)=>prev.filter({
                            "ChatPageContent.useCallback[handleSendMessage]": (msg)=>msg.id !== tempId
                        }["ChatPageContent.useCallback[handleSendMessage]"])
                }["ChatPageContent.useCallback[handleSendMessage]"]);
                toast({
            ...
            }["ChatPageContent.useCallback[handleSendMessage]"], 100);
        }
    }["ChatPageContent.useCallback[handleSendMessage]"], [
        chatId,
        attachments,
        ...
        "ChatPageContent.useEffect": ()=>{
            ...
            if (shouldAutoSendRef.current && attachments.length > 0) {
                ...
                const timer = setTimeout({
                    "ChatPageContent.useEffect.timer": ()=>{
                        handleSendMessage();
                    }
                }["ChatPageContent.useEffect.timer"], 200);
                return ({
                    "ChatPageContent.useEffect": ()=>clearTimeout(timer)
                })["ChatPageContent.useEffect"];
            }
        }
    }["ChatPageContent.useEffect"], [
    ...
    const handleReply = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[handleReply]": (msg)=>{
            setReplyingTo(msg);
            setEditingMessage(null);
        }
    }["ChatPageContent.useCallback[handleReply]"], []);
    // Handle edit
    const handleEdit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[handleEdit]": (msg)=>{
            setEditingMessage(msg);
            setReplyingTo(null);
            setMessage(msg.text || "");
        }
    }["ChatPageContent.useCallback[handleEdit]"], []);
    // Handle delete
    const handleDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[handleDelete]": async (messageId)=>{
            try {
                ...
                const data = await response.json().catch({
                    "ChatPageContent.useCallback[handleDelete]": ()=>({})
                }["ChatPageContent.useCallback[handleDelete]"]);
                if (response.ok) {
                    setMessages({
                        "ChatPageContent.useCallback[handleDelete]": (prev)=>prev.filter({
                                "ChatPageContent.useCallback[handleDelete]": (msg)=>msg.id !== messageId
                            }["ChatPageContent.useCallback[handleDelete]"])
                    }["ChatPageContent.useCallback[handleDelete]"]);
                    ...
                    }["ChatPageContent.useCallback[handleDelete]"], 500);
                    toast({
                        title: "موفق",
    ...
    const scrollToBottom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[scrollToBottom]": (instant = false)=>{
    ...
    const checkScrollPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatPageContent.useCallback[checkScrollPosition]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPageContent.useEffect": ()=>{
            ...
            pollForNewMessages();
            const interval = setInterval({
                "ChatPageContent.useEffect.interval": ()=>{
                    pollForNewMessages();
                    checkSupportTyping();
                }
            }["ChatPageContent.useEffect.interval"], 3000);
            return ({
                "ChatPageContent.useEffect": ()=>clearInterval(interval)
            })["ChatPageContent.useEffect"];
        }
    }["ChatPageContent.useEffect"], [
        chatId,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPageContent.useEffect": ()=>{
            ...
            return ({
                "ChatPageContent.useEffect": ()=>container.removeEventListener("scroll", handleScroll)
            })["ChatPageContent.useEffect"];
        }
    }["ChatPageContent.useEffect"], [
        checkScrollPosition
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: step === "info" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                msg.attachments && msg.attachments.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: msg.attachments.map((attachment)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ChatPageContent, "5/wNR/xlcDlHAMQEZ+bV4SLWOBc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_772385be._.js.map