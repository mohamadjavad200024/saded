...
function SafeImage({ src, alt, fill = false, width, height, className = "", priority = false, loading = "eager", sizes, onError, placeholder = "empty", blurDataURL, productId }) {
    ...
    const [imageSrc, setImageSrc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(placeholderUrl);
    ...
    // دریافت URL تصویر از multiple sources
    const getImageUrl = ()=>{
        // 1. از src prop
    ...
    // تبدیل تصویر به data URL برای تضمین لود شدن
    const convertToDataUrl = async (imageUrl)=>{
        // اگر قبلاً cache شده، از cache استفاده کن
        if (cacheRef.current.has(imageUrl)) {
            return cacheRef.current.get(imageUrl) || null;
        }
        // اگر data URL یا blob URL است، مستقیماً برگردان
        if (imageUrl.startsWith('data:') || imageUrl.startsWith('blob:')) {
            cacheRef.current.set(imageUrl, imageUrl);
            return imageUrl;
        }
        try {
            ...
            // Fetch تصویر
            // برای relative URLs، از window.location.origin استفاده کن
            ...
            return new Promise((resolve)=>{
                ...
                reader.onloadend = ()=>{
                    ...
                    cacheRef.current.set(imageUrl, dataUrl);
                    resolve(dataUrl);
                };
            ...
            // اگر fetch ناموفق بود (مثلاً CORS)، از URL اصلی استفاده کن
            if (error.name !== 'AbortError') {
                // فقط در development log کن
                if ("TURBOPACK compile-time truthy", 1) {
                    console.warn('Failed to convert image to data URL, will use original URL:', imageUrl);
                }
            }
            return null;
        }
    ...
    // Load تصویر با تضمین
    const loadImageWithGuarantee = async (imageUrl)=>{
        setIsLoading(true);
        setHasError(false);
        // ابتدا تصویر را به data URL تبدیل کن
        const dataUrl = await convertToDataUrl(imageUrl);
        if (dataUrl) {
            // اگر تبدیل موفق بود، از data URL استفاده کن
            setImageSrc(dataUrl);
            setIsLoading(false);
            setHasError(false);
            return true;
        }
        // اگر تبدیل ناموفق بود، از URL اصلی استفاده کن
        // اما با preload
        return new Promise((resolve)=>{
            const img = new Image();
            img.onload = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SafeImage.useEffect": ()=>{
            ...
            // Load تصویر با تضمین
            loadImageWithGuarantee(imageUrl).then({
                "SafeImage.useEffect": (success)=>{
                    if (!success) {
                        // اگر لود ناموفق بود، از product store fallback کن
                        if (productId) {
                            const product = getProduct(productId);
                            if (product?.images && Array.isArray(product.images) && product.images.length > 0) {
                                const fallbackImage = product.images.find({
                                    "SafeImage.useEffect.fallbackImage": (img)=>img && typeof img === 'string' && img.trim() !== '' && img !== imageUrl
                                }["SafeImage.useEffect.fallbackImage"]);
                                if (fallbackImage) {
                                    loadImageWithGuarantee(fallbackImage.trim());
                                    return;
                                }
                            }
                        }
    ...
    const handleError = ()=>{
        ...
        // Retry با data URL conversion
        loadImageWithGuarantee(imageUrl).then((success)=>{
            if (!success) {
                // از product store fallback کن
                if (productId) {
                    const product = getProduct(productId);
                    if (product?.images && Array.isArray(product.images) && product.images.length > 0) {
                        const fallbackImage = product.images.find((img)=>img && typeof img === 'string' && img.trim() !== '' && img !== imageUrl);
                        if (fallbackImage) {
                            loadImageWithGuarantee(fallbackImage.trim());
                            return;
                        }
...
_s(SafeImage, "cc1EP2Pwx53C1/vAnUsVuBFea4Y=", false, function() {
    return [
...
"[project]/components/cart/cart-content.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CartContent() {
    _s();
    const { items, updateQuantity, removeItem, getTotal, clearCart, shippingMethod: storeShippingMethod, setShippingMethod, initializeSession, loadFromDatabase } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$cart$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"])();
    ...
    const [localShippingMethod, setLocalShippingMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(storeShippingMethod);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // Initialize session and load cart from database on mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartContent.useEffect": ()=>{
            const initCart = {
                "CartContent.useEffect.initCart": async ()=>{
                    setIsLoading(true);
                    try {
                        initializeSession();
            ...
            }["CartContent.useEffect.initCart"];
            initCart();
        }
    }["CartContent.useEffect"], [
        initializeSession,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            ...
                            children: [
                                ...
                                (airAvailable || seaAvailable) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                airAvailable && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                seaAvailable && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                shipping > 0 && shipping === 50000 && total < 500000 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            onClick: async ()=>{
                                                try {
                                                    ...
                                                    const orderData = {
                                                        ...
                                                        shippingMethod: storeShippingMethod || "air"
                                                    };
                                                    // Create a blob with order details
                                                    const invoiceText = `
فاکتور خرید - ساد
===================

${items.map((item, index)=>`${index + 1}. ${item.name} - ${item.quantity} عدد - ${(item.price * item.quantity).toLocaleString("fa-IR")} تومان`).join("\n")}

جمع کل: ${getTotal().toLocaleString("fa-IR")} تومان
هزینه ارسال: ${shipping === 0 ? "رایگان" : `${shipping.toLocaleString("fa-IR")} تومان`}
مبلغ نهایی: ${(getTotal() + shipping).toLocaleString("fa-IR")} تومان
...
_s(CartContent, "TWRPdZ6NshRpQiUV7WdYqlZoj84=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$cart$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$product$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductStore"],
...
//# sourceMappingURL=_84a40c30._.js.map