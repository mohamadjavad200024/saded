...
function MyOrdersPageContent() {
    _s();
    const { orders, loadOrdersFromDB, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$order$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrderStore"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const { user, isAuthenticated, hasCheckedAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    // Load orders on mount and when user changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyOrdersPageContent.useEffect": ()=>{
            ...
            if (hasCheckedAuth && isAuthenticated && user?.id) {
                ...
                loadOrdersFromDB().then({
                    "MyOrdersPageContent.useEffect": ()=>{
                        ...
                        setTimeout({
                            "MyOrdersPageContent.useEffect": ()=>{
                                const currentOrders = __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$order$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrderStore"].getState().orders;
                        ...
                        }["MyOrdersPageContent.useEffect"], 100);
                    }
                }["MyOrdersPageContent.useEffect"]).catch({
                    "MyOrdersPageContent.useEffect": (err)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyOrdersPageContent.useEffect": ()=>{
            const handleVisibilityChange = {
                "MyOrdersPageContent.useEffect.handleVisibilityChange": ()=>{
            ...
            return ({
                "MyOrdersPageContent.useEffect": ()=>document.removeEventListener('visibilitychange', handleVisibilityChange)
            })["MyOrdersPageContent.useEffect"];
        }
    }["MyOrdersPageContent.useEffect"], [
        hasCheckedAuth,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyOrdersPageContent.useEffect": ()=>{
            ...
            const interval = setInterval({
                "MyOrdersPageContent.useEffect.interval": ()=>{
                    loadOrdersFromDB().catch({
                        "MyOrdersPageContent.useEffect.interval": (error)=>{
                            console.error('[Orders Page] Error polling orders:', error);
                        }
                    }["MyOrdersPageContent.useEffect.interval"]);
                }
            }["MyOrdersPageContent.useEffect.interval"], 30000); // 30 seconds
            return ({
                "MyOrdersPageContent.useEffect": ()=>clearInterval(interval)
            })["MyOrdersPageContent.useEffect"];
        }
    }["MyOrdersPageContent.useEffect"], [
        hasCheckedAuth,
    ...
    // دسته‌بندی سفارش‌ها
    const ordersByStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MyOrdersPageContent.useMemo[ordersByStatus]": ()=>{
            const pending = orders.filter({
                "MyOrdersPageContent.useMemo[ordersByStatus].pending": (o)=>o.paymentStatus === "pending"
            }["MyOrdersPageContent.useMemo[ordersByStatus].pending"]);
            const paid = orders.filter({
                "MyOrdersPageContent.useMemo[ordersByStatus].paid": (o)=>o.paymentStatus === "paid"
            }["MyOrdersPageContent.useMemo[ordersByStatus].paid"]);
            const failed = orders.filter({
                "MyOrdersPageContent.useMemo[ordersByStatus].failed": (o)=>o.paymentStatus === "failed"
            }["MyOrdersPageContent.useMemo[ordersByStatus].failed"]);
            const cancelled = orders.filter({
                "MyOrdersPageContent.useMemo[ordersByStatus].cancelled": (o)=>o.status === "cancelled"
            }["MyOrdersPageContent.useMemo[ordersByStatus].cancelled"]);
            return {
                pending,
                paid,
                failed,
...
_s(MyOrdersPageContent, "udtdFDLG5s1FA7q2k6w33mWUTII=", false, function() {
    return [
...
function MyOrdersPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2f$protected$2d$route$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProtectedRoute"], {
        requireAuth: true,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MyOrdersPageContent, {}, void 0, false, {
            fileName: "[project]/app/orders/page.tsx",
            lineNumber: 490,
            columnNumber: 7
        }, this)
...
_c1 = MyOrdersPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "MyOrdersPageContent");
...
//# sourceMappingURL=_f7cf01db._.js.map