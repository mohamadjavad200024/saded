           ...
           AND (status IS NULL OR (status != 'read' AND status IN ('sent', 'delivered', 'sending')))`, [
            ...
            try {
                ...
                if (isAdmin) {
                    ...
                    try {
                        chats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRows"])(`SELECT DISTINCT chatId as id FROM chat_messages`);
                    } catch (error) {
                    ...
                    try {
                        if (!sessionUser) {
                            ...
                            chats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRows"])(`SELECT DISTINCT m.chatId as id
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c251964._.js.map