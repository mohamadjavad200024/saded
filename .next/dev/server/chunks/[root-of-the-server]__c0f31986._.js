...
fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
    ...
    body: JSON.stringify({
        location: 'app/api/auth/me/route.ts:8',
...
async function GET(request) {
    ...
    fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
        ...
        body: JSON.stringify({
            location: 'app/api/auth/me/route.ts:12',
    ...
    try {
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUserFromRequest"])(request);
        ...
        if (error?.message?.includes("not available") || error?.code === "DATABASE_NOT_AVAILABLE" || error?.code === "ECONNREFUSED" || error?.code === "ETIMEDOUT" || error?.message?.includes("connect") || error?.message?.includes("timeout") || error?.message?.includes("ECONNREFUSED")) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c0f31986._.js.map