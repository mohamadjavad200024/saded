...
async function GET(request) {
    try {
        ...
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRows"])(query, [
            ...params,
            limit,
            offset
        ]);
        ...
        const parsedUsers = users.map((u)=>({
                ...
                role: u.role || "user",
                status: u.enabled === 1 || u.enabled === true ? "active" : "inactive",
                avatar: undefined,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(parsedUsers, 200, {
            page,
            limit,
            total,
            totalPages
...
async function POST(request) {
    try {
        ...
        if (!name || typeof name !== "string" || name.trim() === "") {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("نام کاربر الزامی است", 400, "MISSING_NAME");
        }
        if (!email || typeof email !== "string" || email.trim() === "") {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("ایمیل کاربر الزامی است", 400, "MISSING_EMAIL");
        }
        // Basic email validation
        const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        if (!emailRegex.test(email.trim())) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("فرمت ایمیل نامعتبر است", 400, "INVALID_EMAIL");
        }
        if (!password || typeof password !== "string" || password.length < 6) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("رمز عبور باید حداقل 6 کاراکتر باشد", 400, "INVALID_PASSWORD");
        }
        // Check if user with same email exists
        try {
            const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRows"])("SELECT * FROM users WHERE email = ?", [
                email.trim()
            ]);
            if (existing && existing.length > 0) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("کاربری با این ایمیل قبلاً ثبت شده است", 400, "DUPLICATE_EMAIL");
            }
        } catch (checkError) {
            if (checkError instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]) {
                throw checkError;
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error checking existing user:", checkError);
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خطا در بررسی کاربر موجود", 500, "CHECK_ERROR");
        }
        ...
        let insertResult;
        try {
            insertResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`INSERT INTO users (id, email, password, name, role, phone, address, enabled, \`createdAt\`, \`updatedAt\`)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
                id,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error inserting user:", insertError);
            if (insertError?.message?.includes("UNIQUE constraint")) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("کاربری با این ایمیل قبلاً ثبت شده است", 400, "DUPLICATE_EMAIL");
            }
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خطا در ایجاد کاربر", 500, "USER_CREATE_FAILED");
        }
        // Check if insert was successful
        if (insertResult && insertResult.changes === 0) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خطا در ایجاد کاربر - هیچ رکوردی ایجاد نشد", 500, "USER_CREATE_FAILED");
        }
        // Fetch the newly created user
        let newUserResult = [];
        try {
            newUserResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRows"])("SELECT * FROM users WHERE id = ?", [
                id
            ]);
        } catch (fetchError) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error fetching created user:", fetchError);
            ...
            if (insertResult && insertResult.changes > 0) {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(userData, 201);
            }
            throw fetchError;
        }
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(parsedUser, 201);
    } catch (error) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error);
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c4e6347._.js.map