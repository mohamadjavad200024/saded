...
"[project]/app/api/chat/my/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (!sessionUser) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("برای دسترسی به چت باید وارد حساب کاربری خود شوید", 401, "UNAUTHORIZED");
        }
        ...
        if (userId && schema.chatHasUserId) {
            existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])(`SELECT * FROM quick_buy_chats WHERE userId = ? ORDER BY updatedAt DESC LIMIT 1`, [
                userId
            ]);
        } else if (userPhone) {
            existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])(`SELECT * FROM quick_buy_chats WHERE customerPhone = ? ORDER BY updatedAt DESC LIMIT 1`, [
                userPhone
            ]);
        }
        if (existing?.id) {
        ...
        try {
            if (schema.chatHasUserId) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`INSERT INTO quick_buy_chats (id, userId, customerName, customerPhone, customerEmail, status, createdAt, updatedAt)
           VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [
                    chatId,
                    userId,
                    userName,
           ...
           VALUES (?, ?, ?, ?, ?, ?, ?)`, [
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](`خطا در ایجاد چت: ${error?.message || 'خطای نامشخص'}`, 500, "CHAT_CREATION_ERROR");
        }
        const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])(`SELECT * FROM quick_buy_chats WHERE id = ?`, [
            chatId
        ]);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])({
            chatId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f5ed57c3._.js.map