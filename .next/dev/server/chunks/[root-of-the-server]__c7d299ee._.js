...
async function PATCH(request) {
    try {
        ...
        const msg = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])(schema.chatHasUserId ? `SELECT m.id, c.userId as chatUserId, c.customerPhone as chatPhone
           FROM chat_messages m
           JOIN quick_buy_chats c ON c.id = m.chatId
           WHERE m.id = ?
           LIMIT 1` : `SELECT m.id, c.customerPhone as chatPhone
           FROM chat_messages m
           JOIN quick_buy_chats c ON c.id = m.chatId
           WHERE m.id = ?
           LIMIT 1`, [
        ...
        if (!isAdmin) {
            if (!sessionUser) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("برای دسترسی به این پیام باید وارد حساب کاربری خود شوید", 401, "UNAUTHORIZED");
            }
            ...
            if (!isOwnerByUserId && !isOwnerByPhone) throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("شما به این پیام دسترسی ندارید", 403, "FORBIDDEN");
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c7d299ee._.js.map