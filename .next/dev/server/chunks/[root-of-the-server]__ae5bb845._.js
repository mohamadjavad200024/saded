...
async function GET(request, { params }) {
    try {
        ...
        const parsedOrder = {
            ...
            shippingAddress: typeof order.shippingAddress === 'object' && order.shippingAddress !== null ? order.shippingAddress : typeof order.shippingAddress === 'string' ? JSON.parse(order.shippingAddress) : {},
...
async function PUT(request, { params }) {
    try {
        ...
        const isAdmin = sessionUser?.role === "admin";
        if (!isAdmin) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("فقط ادمین می‌تواند سفارش را ویرایش کند", 403, "FORBIDDEN");
        }
        ...
        values.push(id);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`UPDATE orders SET ${setClause} WHERE id = ?`, values);
        ...
        const parsedOrder = {
            ...
            shippingAddress: typeof updatedOrder.shippingAddress === 'object' && updatedOrder.shippingAddress !== null ? updatedOrder.shippingAddress : typeof updatedOrder.shippingAddress === 'string' ? JSON.parse(updatedOrder.shippingAddress) : {},
...
async function DELETE(request, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])("DELETE FROM orders WHERE id = ?", [
            id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae5bb845._.js.map