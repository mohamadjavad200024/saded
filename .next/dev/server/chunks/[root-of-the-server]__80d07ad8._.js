...
"[project]/app/api/settings/page-content/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (!page) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("نام صفحه الزامی است", 400, "MISSING_PAGE");
        }
        // Validate page name
        const validPages = [
            "about",
        ...
        if (!validPages.includes(page)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("نام صفحه معتبر نیست", 400, "INVALID_PAGE");
        }
        // Try to get from database
        let pageContent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM site_settings WHERE `key` = ? LIMIT 1", [
            `page_content_${page}`
        ]);
...
async function PUT(request) {
    try {
        ...
        if (content === undefined || content === null) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("محتوا الزامی است", 400, "MISSING_CONTENT");
        }
      ...
      `);
       ...
       ON DUPLICATE KEY UPDATE value = ?, updatedAt = NOW()`, [
        ...
        // Get updated content
        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM site_settings WHERE `key` = ? LIMIT 1", [
            `page_content_${page}`
        ]);
        // Parse if JSON
...
//# sourceMappingURL=%5Broot-of-the-server%5D__80d07ad8._.js.map