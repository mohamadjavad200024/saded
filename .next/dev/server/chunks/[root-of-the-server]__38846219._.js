...
async function GET(request) {
    ...
    try {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].info("[GET /api/settings] Starting request");
        console.log("[GET /api/settings] Starting request - DEBUG");
        // Ensure settings table exists
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].info("[GET /api/settings] Creating table if not exists");
      ...
      `);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].info("[GET /api/settings] Table ensured");
            console.log("[GET /api/settings] Table ensured - DEBUG");
        } catch (dbError) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("[GET /api/settings] Database error creating table:", dbError);
            console.error("[GET /api/settings] Database error creating table:", dbError);
            throw dbError;
        }
        // Get settings from database
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].info("[GET /api/settings] Fetching settings from database");
      ...
      `);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("[GET /api/settings] Error getting settings:", error);
        console.error("[GET /api/settings] Error getting settings:", error);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("[GET /api/settings] Error details:", {
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"] && error.status === 403) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error instanceof Error ? error : new Error(String(error)), 500);
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__38846219._.js.map