...
async function PATCH(request, { params }) {
    try {
        ...
        const { status } = body;
        if (!status) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("status is required", 400, "MISSING_PARAMS");
        }
        const validStatuses = [
            "pending",
            "processing",
        ...
        if (!validStatuses.includes(status)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("Invalid order status", 400, "INVALID_STATUS");
        }
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`UPDATE orders SET status = ?, \`updatedAt\` = ? WHERE id = ?`, [
            status,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__510297e1._.js.map