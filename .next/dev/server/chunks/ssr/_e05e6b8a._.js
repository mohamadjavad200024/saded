...
;
;
function SafeImage({ src, alt, fill = false, width, height, className = "", priority = false, loading = "eager", sizes, onError, placeholder = "empty", blurDataURL }) {
    const [imageSrc, setImageSrc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        if (!src || typeof src !== 'string' || src.trim() === '') {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPlaceholderImage"])(width || 600, height || 600);
        }
        return src;
    });
    ...
    const originalSrcRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const maxRetries = 10; // افزایش retry count
    ...
    // Force load تصویر با preload
    const forceLoadImage = (imageUrl)=>{
        return new Promise((resolve)=>{
            // برای data URL و blob URL نیازی به preload نیست
            if (imageUrl.startsWith('data:') || imageUrl.startsWith('blob:')) {
                resolve(true);
                return;
            }
            // استفاده از Image object برای preload
            const img = new Image();
            img.crossOrigin = 'anonymous';
            // اضافه کردن timestamp برای جلوگیری از cache
            const separator = imageUrl.includes('?') ? '&' : '?';
            const forceUrl = `${imageUrl}${separator}_force=${Date.now()}`;
            img.src = forceUrl;
            img.onload = ()=>{
                setImageSrc(forceUrl);
                setIsLoaded(true);
                setIsLoading(false);
                setHasError(false);
                resolve(true);
            ...
            img.onerror = ()=>{
                // اگر با force load موفق نشد، بدون timestamp امتحان کن
    ...
    const retryImage = async ()=>{
        if (!originalSrcRef.current || !isValidImageUrl(originalSrcRef.current)) {
            return;
        }
        if (retryCountRef.current >= maxRetries) {
            setHasError(true);
            setIsLoading(false);
            setImageSrc((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPlaceholderImage"])(width || 600, height || 600));
            onError?.();
            return;
        }
        ...
        const retrySrc = `${originalSrc}${separator}_force=${timestamp}&_retry=${retryCountRef.current}`;
        setIsLoading(true);
        setHasError(false);
        // تلاش برای force load
        const success = await forceLoadImage(retrySrc);
        if (!success) {
            // اگر force load موفق نشد، از روش معمولی استفاده کن
            const img = new Image();
            img.src = retrySrc;
            img.crossOrigin = 'anonymous';
            img.onload = ()=>{
    ...
    // Real-time check برای بررسی وضعیت تصویر
    const checkImageStatus = ()=>{
        if (!imgRef.current) return;
        const img = imgRef.current;
        // اگر تصویر کامل لود شده باشد
        ...
        // اگر تصویر لود نشده باشد
        if (img.complete && img.naturalHeight === 0 && !isLoading) {
            setIsLoading(true);
            retryImage();
        }
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        setIsLoading(true);
        setImageSrc(src);
        // Preload link برای تصاویر مهم
        if (priority && isValidImageUrl(src) && !src.startsWith('data:') && !src.startsWith('blob:')) {
        ...
        // Force load تصویر
        forceLoadImage(src).then((success)=>{
            if (!success) {
                // اگر force load موفق نشد، از روش معمولی استفاده کن
                const img = new Image();
                img.src = src;
    ...
    const handleError = ()=>{
        if (!hasError && originalSrcRef.current) {
            setHasError(true);
            setIsLoading(true);
            // Retry بعد از 500ms
            retryTimeoutRef.current = setTimeout(()=>{
    ...
    // استفاده از img tag معمولی برای اطمینان بیشتر
    const imgProps = {
        src: imageSrc,
        alt,
        onError: handleError,
    ...
    if (fill) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                isLoading && !isLoaded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                hasError && !isLoading && !isLoaded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_e05e6b8a._.js.map