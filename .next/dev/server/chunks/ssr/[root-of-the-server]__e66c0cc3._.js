...
"[project]/lib/db/mysql.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
if ("TURBOPACK compile-time truthy", 1) {
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].log("🔍 Database Config:", {
...
function getPool() {
    if (!pool) {
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].log("🔍 Creating MySQL pool with config:", {
                host: DB_CONFIG.host,
                port: DB_CONFIG.port,
        ...
        pool = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mysql2$2f$promise$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].createPool(DB_CONFIG);
        ...
        pool.on("connection", (connection)=>{
            connection.on("error", (err)=>{
                ...
                if (err.code === 'ER_VARIABLE_IS_READONLY' || err.message?.includes('closed state')) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].warn("MySQL connection pool error, will recreate pool:", err.code);
                ...
                if (err.code !== 'ECONNRESET' && err.code !== 'PROTOCOL_CONNECTION_LOST') {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].error("Unexpected error on MySQL connection", err);
                } else if ("TURBOPACK compile-time truthy", 1) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].debug("MySQL connection reset (normal for idle connections)", err.code);
                }
            });
        });
    }
...
async function testConnection() {
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].error("Database connection test failed:", error);
        return false;
    }
}
    ...
    for(let attempt = 0; attempt <= retries; attempt++){
        ...
        try {
            ...
            if (attempt < retries && (error.code === 'ECONNRESET' || error.code === 'PROTOCOL_CONNECTION_LOST' || error.code === 'ETIMEDOUT' || error.fatal)) {
                if ("TURBOPACK compile-time truthy", 1) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].debug(`Database connection error, retrying (${attempt + 1}/${retries})...`, error.code);
                }
            ...
            if (!isDuplicateError) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].error("Database query error:", {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].debug("Database query skipped (duplicate):", {
                    sql: text.substring(0, 100),
                    code: error.code
                });
            }
...
async function ensureDatabase() {
    ...
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].error("Database connection failed:", error);
...
async function initializeTables() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].log("ℹ️  Table initialization should be done via 'npm run setup-mysql'");
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e66c0cc3._.js.map