...
"[project]/components/auth/auth-initializer.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthInitializer() {
    const { checkAuth, hasCheckedAuth, isCheckingAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])();
...
const useProductStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])((set, get)=>({
        ...
        setProducts: (products)=>{
            ...
            const validatedProducts = products.map((product)=>{
                ...
                if (Array.isArray(product.images)) {
                    validatedImages = product.images.map((img)=>{
                        ...
                        const normalized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeImageUrl"])(trimmed);
                        if (!normalized) return null;
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateImageUrl"])(normalized) ? normalized : null;
                    }).filter((img)=>img !== null);
                }
                return {
                    ...product,
        ...
        addProduct: (product)=>set((state)=>{
                // Validate and normalize images - be more lenient with base64
                let validatedImages = [];
                if (Array.isArray(product.images)) {
                    validatedImages = product.images.map((img)=>{
                        if (!img || typeof img !== 'string') return null;
            ...
            try {
                ...
                const products = (result.data || []).map((product)=>{
                    ...
                    if (Array.isArray(product.images)) {
                        validatedImages = product.images.map((img)=>{
                            ...
                            const isValid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateImageUrl"])(normalized);
                    ...
                    } else if (product.images && ("TURBOPACK compile-time value", "development") === 'development') {
                        console.warn('[ProductStore] Product images is not an array:', {
                ...
                if ("TURBOPACK compile-time truthy", 1) {
                    console.log('[ProductStore] Processed products:', {
                        ...
                        firstProductWithImages: products.find((p)=>p.images && p.images.length > 0) ? {
                            id: products.find((p)=>p.images && p.images.length > 0).id,
                            name: products.find((p)=>p.images && p.images.length > 0).name,
                            imagesCount: products.find((p)=>p.images && p.images.length > 0).images.length,
                            firstImagePreview: products.find((p)=>p.images && p.images.length > 0).images[0].substring(0, 100)
                        } : null
                    });
                }
...
const useOrderStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])((set, get)=>({
        ...
        loadOrdersFromDB: async ()=>{
            ...
            try {
                ...
                const { fetchWithAuth } = await __turbopack_context__.A("[project]/lib/api/fetch-with-auth.ts [app-ssr] (ecmascript, async loader)");
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].debug("Loading orders from database...");
                // Log auth state before request
                const authState = __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"].getState();
                ...
                if (response.ok) {
                    ...
                    if (result.success && result.data) {
                        try {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].info(`✅ Loaded ${parsedOrders.length} orders from database`);
                            set({
                                orders: parsedOrders,
                                isLoading: false
                            });
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].info("No orders found in database");
                        set({
                            orders: [],
                            isLoading: false
                        });
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].error(`Failed to load orders: ${response.status} - ${errorText}`);
...
"[project]/hooks/use-page-preload.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function usePagePreload() {
    ...
    const [isPreloading, setIsPreloading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    const [preloadError, setPreloadError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const { loadProductsFromDB } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$product$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductStore"])();
    ...
    const { loadOrdersFromDB } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$order$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useOrderStore"])();
    const { isAuthenticated, hasCheckedAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        let isMounted = true;
        const preloadData = async ()=>{
            try {
                ...
                if (pathname.startsWith("/products")) {
                    ...
                    commonPromises.push(loadProductsFromDB(true).catch((err)=>{
                ...
                if (pathname.startsWith("/orders") || pathname.startsWith("/order")) {
                    ...
                    if (hasCheckedAuth && isAuthenticated) {
                        commonPromises.push(loadOrdersFromDB().catch((err)=>{
...
"[project]/components/ui/page-loader.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/layout/page-preloader.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$page$2d$preload$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-page-preload.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$page$2d$loader$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/page-loader.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
function PagePreloader({ children, showLoader = true }) {
    const { isPreloading, preloadError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$page$2d$preload$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePagePreload"])();
    ...
    if (isPreloading && showLoader) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$page$2d$loader$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PageLoader"], {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$notifications$2f$notification$2d$center$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/notifications/notification-center.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2f$auth$2d$initializer$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/auth/auth-initializer.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$page$2d$preloader$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/layout/page-preloader.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Providers({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$themes$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ThemeProvider"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
            client: queryClient,
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2f$auth$2d$initializer$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthInitializer"], {}, void 0, false, {
                    fileName: "[project]/components/providers.tsx",
                    lineNumber: 44,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$page$2d$preloader$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PagePreloader"], {
                    children: children
                }, void 0, false, {
                    fileName: "[project]/components/providers.tsx",
                    lineNumber: 45,
                ...
                if (!response.ok) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].warn("Could not parse error response", {
                                status: response.status
                            });
                        }
                    }
                    ...
                    if (response.status >= 400) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].error("Failed to sync cart to database:", errorInfo);
                    }
                } else {
                    try {
                        const result = await response.json();
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].Fragment, {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                                href: item.href,
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("flex flex-col items-center justify-center", "flex-1 h-12 rounded-md", "transition-all duration-200", "relative", isActive ? "text-primary" : "text-muted-foreground hover:text-foreground", "active:scale-95"),
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Icon, {
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("h-5 w-5 transition-transform duration-200", isActive && "scale-110")
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/layout/bottom-navigation.tsx",
                                                                lineNumber: 194,
                                                                columnNumber: 25
                                                            ...
                                                            isCart && itemCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("absolute -top-0.5 -right-0.5", "h-4 w-4 rounded-full", "bg-primary text-primary-foreground", "text-[9px] font-bold", "flex items-center justify-center", "min-w-[16px] px-0.5", "border border-background"),
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("text-[10px] font-medium mt-1 leading-tight", "transition-colors duration-200", isActive && "font-semibold"),
                                                        children: item.name
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/layout/bottom-navigation.tsx",
                                                        lineNumber: 217,
                                                    ...
                                                    isActive && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("absolute top-0 left-1/2 -translate-x-1/2", "w-6 h-0.5 rounded-full", "bg-primary", "animate-in fade-in slide-in-from-top-1 duration-200")
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/layout/bottom-navigation.tsx",
                                                        lineNumber: 227,
                                                        columnNumber: 25
                                            ...
                                            isHome && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                                href: "/chat",
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("flex flex-col items-center justify-center", "flex-1 h-12 rounded-md", "transition-all duration-200", "relative", pathname === "/chat" ? "text-primary" : "text-muted-foreground hover:text-foreground", "active:scale-95"),
                                                "aria-label": "چت",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "relative",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$message$2d$circle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MessageCircle$3e$__["MessageCircle"], {
                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("h-5 w-5 transition-transform duration-200", pathname === "/chat" && "scale-110")
                                                        }, void 0, false, {
                                                            fileName: "[project]/components/layout/bottom-navigation.tsx",
                                                            lineNumber: 256,
                                                            columnNumber: 27
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("text-[10px] font-medium mt-1 leading-tight", "transition-colors duration-200", pathname === "/chat" && "font-semibold"),
                                                        children: "چت"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/layout/bottom-navigation.tsx",
                                                        lineNumber: 263,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2d49712._.js.map