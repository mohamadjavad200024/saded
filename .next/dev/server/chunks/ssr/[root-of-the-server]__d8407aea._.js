...
"[project]/lib/product-utils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useProductStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])((set, get)=>({
        ...
        setProducts: (products)=>{
            ...
            const validatedProducts = products.map((product)=>{
                ...
                const normalizedImages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$product$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeImages"])(product.images);
            ...
            try {
                ...
                const products = (result.data || []).map((product)=>{
                    ...
                    const processedProduct = {
                        ...product,
                        images: validatedImages,
                        specifications: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$product$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeSpecifications"])(product.specifications),
                        // Ensure boolean fields are properly converted from numbers (0/1) to booleans
                        inStock: product.inStock !== undefined ? Boolean(product.inStock) : true,
                        enabled: product.enabled !== undefined ? Boolean(product.enabled) : true,
                        vinEnabled: product.vinEnabled !== undefined ? Boolean(product.vinEnabled) : false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d8407aea._.js.map