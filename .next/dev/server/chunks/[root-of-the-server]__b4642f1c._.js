...
"[project]/app/api/orders/[id]/payment-status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        if (!paymentStatus) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("paymentStatus is required", 400, "MISSING_PARAMS");
        }
        const validStatuses = [
            "pending",
            "paid",
        ...
        if (!validStatuses.includes(paymentStatus)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("Invalid payment status", 400, "INVALID_STATUS");
        }
        const order = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM orders WHERE id = ?", [
            id
        ]);
        if (!order) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("سفارش یافت نشد", 404, "ORDER_NOT_FOUND");
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`UPDATE orders SET \`paymentStatus\` = ?, \`updatedAt\` = ? WHERE id = ?`, [
            paymentStatus,
            new Date().toISOString(),
            id
        ]);
        const updatedOrder = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM orders WHERE id = ?", [
            id
        ]);
        if (!updatedOrder) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("سفارش پس از به‌روزرسانی یافت نشد", 500, "ORDER_UPDATE_FAILED");
        }
        // Parse JSON fields with error handling
        let parsedItems = [];
        let parsedShippingAddress = {};
        try {
            parsedItems = Array.isArray(updatedOrder.items) ? updatedOrder.items : typeof updatedOrder.items === 'string' ? JSON.parse(updatedOrder.items) : [];
        } catch (e) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error parsing items:", e);
            parsedItems = [];
        }
        try {
            parsedShippingAddress = typeof updatedOrder.shippingAddress === 'object' && updatedOrder.shippingAddress !== null ? updatedOrder.shippingAddress : typeof updatedOrder.shippingAddress === 'string' ? JSON.parse(updatedOrder.shippingAddress) : {};
        } catch (e) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error parsing shippingAddress:", e);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(parsedOrder);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b4642f1c._.js.map