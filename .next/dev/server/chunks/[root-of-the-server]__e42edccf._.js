...
"[project]/app/api/chat/message/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        if (!text && (!attachments || attachments.length === 0)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("text or attachments are required", 400, "MISSING_PARAMS");
        }
        const message = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])(schema.chatHasUserId ? `SELECT m.*, c.userId as chatUserId, c.customerPhone as chatPhone
           FROM chat_messages m
           JOIN quick_buy_chats c ON c.id = m.chatId
           WHERE m.id = ?
           LIMIT 1` : `SELECT m.*, c.customerPhone as chatPhone
           FROM chat_messages m
           JOIN quick_buy_chats c ON c.id = m.chatId
           WHERE m.id = ?
           LIMIT 1`, [
        ...
        if (!message) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("پیام یافت نشد", 404, "MESSAGE_NOT_FOUND");
        }
        if (!isAdmin) {
            if (!sessionUser) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("برای ویرایش پیام باید وارد حساب کاربری خود شوید", 401, "UNAUTHORIZED");
            }
            ...
            if (!isOwnerByUserId && !isOwnerByPhone) throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("شما دسترسی به این پیام را ندارید", 403, "FORBIDDEN");
            if (String(message.sender) !== "user") {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("شما فقط می‌توانید پیام‌های خودتان را ویرایش کنید", 403, "FORBIDDEN");
            }
        }
...
async function DELETE(request, { params }) {
    try {
        ...
        if (!isAdmin && !isSupportMessage && !isUserMessage) {
            if (!sessionUser) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("برای حذف پیام باید وارد حساب کاربری خود شوید", 401, "UNAUTHORIZED");
            }
            const chatPhone = message.chatPhone ? String(message.chatPhone) : "";
            const chatUserId = schema.chatHasUserId && message.chatUserId ? String(message.chatUserId) : "";
            const isOwnerByUserId = schema.chatHasUserId && chatUserId === sessionUser.id;
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])("DELETE FROM chat_messages WHERE id = ?", [
            id
        ]);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e42edccf._.js.map