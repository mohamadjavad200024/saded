...
async function GET(request) {
    try {
        let vehicles = [];
        try {
            vehicles = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRows"])("SELECT * FROM vehicles WHERE enabled = TRUE ORDER BY name ASC");
        } catch (dbError) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error fetching vehicles:", dbError);
            ...
            if (dbError?.code === "ER_NO_SUCH_TABLE" || dbError?.message?.includes("doesn't exist") || dbError?.message?.includes("does not exist")) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].warn("Vehicles table does not exist yet, returning empty array");
            ...
            if (dbError?.message?.includes("not available") || dbError?.code === "DATABASE_NOT_AVAILABLE" || dbError?.code === "ECONNREFUSED") {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].warn("Database not available, returning empty vehicles array");
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])([]);
            }
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])([]);
        }
        const parsedVehicles = vehicles.map((v)=>{
            const vehicle = {
                ...v,
                logo: v.logo && v.logo.trim() !== '' ? v.logo : null,
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].log('[GET /api/vehicles] Parsed vehicle:', {
                    id: vehicle.id,
                    name: vehicle.name,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(parsedVehicles);
    } catch (error) {
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("GET /api/vehicles error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error);
    }
}
async function POST(request) {
    try {
        ...
        if (!name || typeof name !== "string" || name.trim() === "") {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("نام خودرو الزامی است", 400, "MISSING_NAME");
        }
        try {
            // Check if vehicle with same name exists
            let existing = [];
            try {
                existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRows"])("SELECT * FROM vehicles WHERE name = ?", [
                    name.trim()
                ]);
            } catch (checkError) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error checking existing vehicle:", checkError);
                // If table doesn't exist, that's okay - we'll create it
                if (checkError?.code === "ER_NO_SUCH_TABLE" || checkError?.message?.includes("doesn't exist") || checkError?.message?.includes("does not exist")) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].warn("Vehicles table does not exist yet, will be created on insert");
                    existing = [];
                } else if (checkError?.message?.includes("not available") || checkError?.code === "DATABASE_NOT_AVAILABLE") {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("دیتابیس در دسترس نیست", 503, "DATABASE_NOT_AVAILABLE");
                } else {
                    throw checkError;
                }
            }
            if (existing && existing.length > 0) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خودرو با این نام قبلاً ایجاد شده است", 400, "DUPLICATE_VEHICLE");
            }
            ...
            let insertResult;
            try {
                insertResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`INSERT INTO vehicles (id, name, logo, models, enabled, \`createdAt\`, \`updatedAt\`)
           VALUES (?, ?, ?, ?, ?, ?, ?)`, [
                    id,
                    name.trim(),
                    logo || null,
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error inserting vehicle:", insertError);
                // If table doesn't exist, provide helpful error message
                if (insertError?.code === "ER_NO_SUCH_TABLE" || insertError?.message?.includes("doesn't exist") || insertError?.message?.includes("does not exist")) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("جدول vehicles وجود ندارد. لطفاً ابتدا setup script را اجرا کنید.", 500, "TABLE_NOT_EXISTS");
                }
                if (insertError?.message?.includes("not available") || insertError?.code === "DATABASE_NOT_AVAILABLE") {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("دیتابیس در دسترس نیست", 503, "DATABASE_NOT_AVAILABLE");
                }
                throw insertError;
            }
            // Fetch the newly created vehicle
            let newVehicleResult = [];
            try {
                newVehicleResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRows"])("SELECT * FROM vehicles WHERE id = ?", [
                    id
                ]);
            } catch (fetchError) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("Error fetching created vehicle:", fetchError);
                if (insertResult && insertResult.changes > 0) {
                    ...
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(parsedVehicle, 201);
                }
                throw fetchError;
            }
            if (!newVehicleResult || newVehicleResult.length === 0) {
                ...
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خطا در ایجاد خودرو", 500, "VEHICLE_CREATE_FAILED");
            }
            ...
            if (dbError instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(dbError);
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("POST /api/vehicles database error:", dbError);
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خطا در ایجاد خودرو", 500, "VEHICLE_CREATE_ERROR");
        }
    } catch (error) {
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error);
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("POST /api/vehicles error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error);
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__61fcfef1._.js.map