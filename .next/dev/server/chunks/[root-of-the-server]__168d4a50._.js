...
"[project]/app/api/settings/site-content/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let content = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM site_settings WHERE `key` = 'site_content' LIMIT 1");
        // If not found, return default content
        if (!content || !content.value) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(defaultContent);
        }
        // Parse JSON content
        try {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(parsedContent);
        } catch (parseError) {
...
async function PUT(request) {
    try {
        ...
        if (!content || typeof content !== "object") {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("محتوا الزامی است و باید یک object باشد", 400, "MISSING_CONTENT");
        }
        // Validate structure
        if (!content.footer) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("ساختار محتوا نادرست است", 400, "INVALID_STRUCTURE");
        }
        // Validate footer structure
        if (!content.footer.about || !content.footer.about.title) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("بخش درباره ساد باید عنوان داشته باشد", 400, "INVALID_STRUCTURE");
        }
        if (!content.footer.contact || !content.footer.contact.title) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("بخش تماس با ما باید عنوان داشته باشد", 400, "INVALID_STRUCTURE");
        }
        // Validate email format if provided
        if (content.footer.contact.email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(content.footer.contact.email)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("فرمت ایمیل معتبر نیست", 400, "INVALID_EMAIL");
        }
      ...
      `);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`INSERT INTO site_settings (\`key\`, value, updatedAt) 
       ...
       ON DUPLICATE KEY UPDATE value = ?, updatedAt = NOW()`, [
        ...
        // Get updated content
        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM site_settings WHERE `key` = 'site_content' LIMIT 1");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__168d4a50._.js.map