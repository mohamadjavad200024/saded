...
const productSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["object"]({
    ...
    vehicle: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"]().max(255, "شناسه خودرو نمی‌تواند بیشتر از 255 کاراکتر باشد").optional().nullable(),
    model: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"]().max(255, "مدل نمی‌تواند بیشتر از 255 کاراکتر باشد").optional().nullable(),
...
"[project]/lib/image-utils.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/image-utils.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(request) {
    ...
    try {
        ...
        const parsedProducts = products.map((p)=>{
            ...
            const normalizedImages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$product$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeImages"])(p.images);
            const validatedImages = normalizedImages.map((img)=>{
                ...
                const normalized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeImageUrl"])(trimmed);
                if (!normalized) return null;
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateImageUrl"])(normalized) ? normalized : null;
            }).filter((img)=>img !== null);
            return {
                ...p,
...
async function POST(request) {
    try {
        ...
        if (body.name && body.price !== undefined && !body.filters) {
            ...
            const { name, description, price, originalPrice, brand, category, vehicle, model, vin, vinEnabled, airShippingEnabled, seaShippingEnabled, airShippingCost, seaShippingCost, stockCount, inStock, enabled, images, tags, specifications } = validatedData;
            ...
            try {
                const insertResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`INSERT INTO products (id, name, description, price, \`originalPrice\`, brand, category, vehicle, model, vin, \`vinEnabled\`, \`airShippingEnabled\`, \`seaShippingEnabled\`, \`airShippingCost\`, \`seaShippingCost\`, \`stockCount\`, \`inStock\`, enabled, images, tags, specifications, \`createdAt\`, \`updatedAt\`)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
                    productData.id,
                    productData.name,
            ...
            const normalizedImages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$product$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeImages"])(newProduct.images);
            const validatedImages = normalizedImages.map((img)=>{
                if (!img || typeof img !== 'string') return null;
                const trimmed = img.trim();
                if (trimmed === '') return null;
                ...
                const normalized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeImageUrl"])(trimmed);
                return normalized && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateImageUrl"])(normalized) ? normalized : null;
            }).filter((img)=>img !== null);
            const parsedProduct = {
                ...newProduct,
                images: validatedImages,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4e563a3f._.js.map