...
"[project]/app/api/vehicles/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        try {
            const vehicle = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM vehicles WHERE id = ?", [
                id
            ]);
            if (!vehicle) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خودرو یافت نشد", 404, "VEHICLE_NOT_FOUND");
            }
            const parsedVehicle = {
                ...vehicle,
                logo: vehicle.logo && vehicle.logo.trim() !== '' ? vehicle.logo : null,
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(parsedVehicle);
        } catch (dbError) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("GET /api/vehicles/[id] database error:", dbError);
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خطا در دریافت خودرو", 500, "VEHICLE_FETCH_ERROR");
        }
    } catch (error) {
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("GET /api/vehicles/[id] error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error);
    }
}
async function PUT(request, { params }) {
    ...
    fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
        ...
        body: JSON.stringify({
            location: 'app/api/vehicles/[id]/route.ts:53',
    ...
    try {
        ...
        fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
            ...
            body: JSON.stringify({
                location: 'app/api/vehicles/[id]/route.ts:58',
        ...
        const body = await request.json().catch((jsonError)=>{
            ...
            fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
                ...
                body: JSON.stringify({
                    location: 'app/api/vehicles/[id]/route.ts:59',
        ...
        fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
            ...
            body: JSON.stringify({
                location: 'app/api/vehicles/[id]/route.ts:63',
                message: 'After request.json() success',
                data: {
                    hasName: !!body.name,
                    hasLogo: !!body.logo,
                    logoType: typeof body.logo,
                    logoLength: body.logo ? String(body.logo).length : 0,
                    hasModels: !!body.models,
                    modelsType: typeof body.models
                },
                timestamp: Date.now(),
                sessionId: 'debug-session',
                runId: 'run1',
        ...
        try {
            ...
            const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM vehicles WHERE id = ?", [
                id
            ]);
            if (!existing) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خودرو یافت نشد", 404, "VEHICLE_NOT_FOUND");
            ...
            if (name && name !== existing.name) {
                const nameCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM vehicles WHERE name = ? AND id != ?", [
                    name.trim(),
                    id
                ]);
                if (nameCheck) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خودرو با این نام قبلاً وجود دارد", 400, "DUPLICATE_VEHICLE");
                }
            }
            ...
            fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
                ...
                body: JSON.stringify({
                    location: 'app/api/vehicles/[id]/route.ts:83',
                    message: 'Before runQuery UPDATE',
                    data: {
                        logoValueType: typeof logo,
                        logoLength: logo ? String(logo).length : 0,
                        logoIsNull: logo === null,
                        logoIsUndefined: logo === undefined,
                        existingLogoLength: existing.logo ? String(existing.logo).length : 0
                    },
                    timestamp: Date.now(),
                    sessionId: 'debug-session',
                    runId: 'run1',
            ...
            // #endregion
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])(`UPDATE vehicles SET name = ?, logo = ?, models = ?, enabled = ?, \`updatedAt\` = ? WHERE id = ?`, [
                ...
                fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
                    ...
                    body: JSON.stringify({
                        location: 'app/api/vehicles/[id]/route.ts:93',
                        message: 'runQuery UPDATE error',
                        data: {
            ...
            fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
                ...
                body: JSON.stringify({
                    location: 'app/api/vehicles/[id]/route.ts:95',
                    message: 'After runQuery UPDATE success',
                    data: {
                        timestamp: Date.now()
                    },
                    timestamp: Date.now(),
            ...
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRow"])("SELECT * FROM vehicles WHERE id = ?", [
                id
            ]);
            // #region agent log
            fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
                ...
                body: JSON.stringify({
                    location: 'app/api/vehicles/[id]/route.ts:96',
                    message: 'Before parsing vehicle response',
                    data: {
                        hasUpdated: !!updated,
                        updatedLogoType: updated?.logo ? typeof updated.logo : 'none',
                        updatedModelsType: updated?.models ? typeof updated.models : 'none'
                    },
                    timestamp: Date.now(),
                    sessionId: 'debug-session',
                    runId: 'run1',
            ...
            fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
                ...
                body: JSON.stringify({
                    location: 'app/api/vehicles/[id]/route.ts:106',
                    message: 'Before return success response',
                    data: {
                        parsedLogoType: typeof parsedVehicle.logo,
                        parsedModelsIsArray: Array.isArray(parsedVehicle.models)
                    },
                    timestamp: Date.now(),
                    sessionId: 'debug-session',
                    runId: 'run1',
            ...
            fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
                ...
                body: JSON.stringify({
                    location: 'app/api/vehicles/[id]/route.ts:107',
                    message: 'Database error catch block',
                    data: {
                        isAppError: dbError instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"],
                        errorMessage: dbError?.message,
                        errorCode: dbError?.code,
                        errorName: dbError?.name,
                        errorStack: dbError?.stack?.substring(0, 200)
                    },
                    timestamp: Date.now(),
                    sessionId: 'debug-session',
                    runId: 'run1',
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("PUT /api/vehicles/[id] database error:", dbError);
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خطا در به‌روزرسانی خودرو", 500, "VEHICLE_UPDATE_ERROR");
        }
    } catch (error) {
        // #region agent log
        fetch('http://127.0.0.1:7242/ingest/6e2493c0-cc8b-4c0b-9456-c04638b7e615', {
            ...
            body: JSON.stringify({
                location: 'app/api/vehicles/[id]/route.ts:114',
                message: 'Outer error catch block',
                data: {
                    isAppError: error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"],
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("PUT /api/vehicles/[id] error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error);
    }
}
async function DELETE(request, { params }) {
    try {
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])("DELETE FROM vehicles WHERE id = ?", [
                id
            ]);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("DELETE /api/vehicles/[id] database error:", dbError);
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("خطا در حذف خودرو", 500, "VEHICLE_DELETE_ERROR");
        }
    } catch (error) {
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error);
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("DELETE /api/vehicles/[id] error:", error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$route$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(error);
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__48e4c7c9._.js.map