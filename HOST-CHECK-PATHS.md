...
# اجرای debug script
node debug-check-paths.js

# نمایش log
cat .cursor/debug.log | tail -50
```

این script بررسی می‌کند که:
- مسیر فعلی پروژه چیست
- کدام مسیرها وجود دارند
- کدام مسیر package.json و server.js دارد
- آیا tailwindcss نصب شده
- ecosystem.config.js در کجا است

بعد از دریافت log، فرمان‌های درست برای run را می‌دهم.
