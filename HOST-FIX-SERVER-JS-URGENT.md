# آپدیت فوری server.js

## مشکل:
- server.js آپدیت نشده (هنوز [DEBUG] ندارد)
...
# 1. پشتیبان‌گیری از server.js فعلی
...
# 3. بررسی اینکه فایل آپدیت شده
echo "=== Verifying update ==="
grep -c "\[DEBUG\]" server.js && echo "✓ [DEBUG] found - file updated" || echo "✗ [DEBUG] NOT found - update failed"
